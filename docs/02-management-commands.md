...
*How `manage.py` subcommands work, and the 62 that CMWEB defines.*
...
62 commands across 13 apps.

| App | Count | Theme |
| --- | --- | --- |
| `explorer` | 20 | Indexing builds, commits, repositories |
| `base` | 5 | Version, cache, auth setup, git sync |
