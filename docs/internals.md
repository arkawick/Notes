...
| # | Guide | Covers |
| --- | --- | --- |
| 1 | [Django apps](01-django-apps.md) | Projects vs. apps, `INSTALLED_APPS`, the 24 CMWEB entries (21 app directories), adding one |
| 2 | [Management commands](02-management-commands.md) | `manage.py` subcommands, the 62 CMWEB defines, `Parameter` config |
...
| 6 | [Migrations](06-migrations.md) | Schema versioning, the 102 CMWEB migrations, the ones that bite |
...
> **Running CMWEB in production?** The [operations reference](operations/README.md)
> catalogues the 62 management commands, the indexing pipeline, the 47 Jenkins
> jobs and how commands map to them, the Ansible roles, and the Apache vhost.

> **Learning Django itself?** These eight guides are *reference* — they describe
> what CMWEB does. If you are working through Django's concepts (MVT, models,
> views, templates, migrations) rather than looking something up, start with the
> [learning track](learning/README.md) instead: nine chapters that teach each
> concept from first principles and then show it in this codebase, with
> exercises against the local instance.
